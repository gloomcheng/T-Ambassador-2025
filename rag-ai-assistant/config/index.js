...
const config = Object.freeze({
  ...
  GEMINI_MODEL: env.GEMINI_MODEL || 'gemini-2.0-flash-exp',
  GEMINI_EMBEDDING_MODEL: env.GEMINI_EMBEDDING_MODEL || 'text-embedding-004',
  GEMINI_TIMEOUT: env.GEMINI_TIMEOUT || env.APP_API_TIMEOUT,
  RAG_ENABLED: env.RAG_ENABLED === 'true' || false,
  RAG_SIMILARITY_THRESHOLD: Number(env.RAG_SIMILARITY_THRESHOLD) || 0.7,
  RAG_TOP_K: Number(env.RAG_TOP_K) || 3,
  RAG_DOCUMENTS_PATH: env.RAG_DOCUMENTS_PATH || './data/documents',
});
