...
/**
 * Run OpenAI Assistant API (contributed by Christine Bear)
 * Requires OPENAI_ASSISTANT_ID to be set in environment
...
const runAssistant = async (userMessage) => {
  ...
  try {
    ...
    return lastMsg || 'Unable to get Assistant response';
  } catch (err) {
